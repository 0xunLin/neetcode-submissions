...
class Solution:
    def mergeTwoLists(self, list1: Optional[ListNode], list2: Optional[ListNode]) -> Optional[ListNode]:
        ...
        while list1 and list2: # looped and checked until both list and list2 have elements to process in them
            ...
            tail = tail.next # the merged list grows by an element either way, so it is made to point to the newly added tail
